    ...
    >
      ...
      <Text
        style={[
          ...
          { fontSize: 14, color: headerTextColor },
        ]}
      >
      ...
      >
        <View
          style={[headerStyles.circleIcon, { backgroundColor: circleBgColor }]}
        >
          <View style={headerStyles.waveIcon}>
            <View
              style={[
                headerStyles.waveCircle,
                {
                  width: 8,
                  height: 8,
                  borderRadius: 4,
  ...
  return (
    <>
      ...
      <Stack screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen
          name="settings"
          options={{ headerShown: true, header: () => <SettingsHeader /> }}
        />
        <Stack.Screen
          name="edit-profile"
          options={{
