...
export default function LoginScreen() {
  ...
  const handleFacebookLogin = async () => {
    try {
      ...
      const msg =
        e instanceof ApiError ? e.message : e?.message || "Facebook 登录失败";
      Alert.alert(t("error"), msg);
    }
  };
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const msg =
        e instanceof ApiError ? e.message : e?.message || "Google 登录失败";
      Alert.alert(t("error"), msg);
    }
  };
  ...
  const handleAppleLogin = async () => {
    try {
      ...
      const msg =
        e instanceof ApiError ? e.message : e?.message || "Apple 登录失败";
      Alert.alert(t("error"), msg);
    }
  };
