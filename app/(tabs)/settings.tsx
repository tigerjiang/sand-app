    ...
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          ...
          <Text style={[styles.sectionTitle, { color: sectionTextColor }]}>{t("deviceSettings")}</Text>
        </View>
        <View style={[styles.divider, { backgroundColor: dividerColor }]} />
        ...
        <View style={styles.drawingSpeedContainer}>
          <Text style={[styles.settingLabel, { color: textColor, marginBottom: 16 }]}>{t("drawingSpeed")}</Text>
          <View style={[styles.sliderContainer, { backgroundColor: sliderBgColor }]}>
            <View style={styles.sliderWrapper}>
              ...
              {showSpeedIndicator && (
                ...
                >
                  <Svg width={40} height={32} viewBox="0 0 40 32" style={styles.teardropSvg}>
                    <Path
                      d="M20 0 C24 0 28 2 30 6 C32 10 32 14 30 18 C28 22 24 24 20 32 C16 24 12 22 10 18 C8 14 8 10 10 6 C12 2 16 0 20 0 Z"
                      fill={sliderActiveColor}
                    />
                  </Svg>
                  <View style={styles.valueTextContainer}>
                    <Text style={styles.valueText}>{Math.round(drawingSpeed)}</Text>
                  </View>
                </View>
              )}
            </View>
        ...
        <TouchableOpacity style={styles.settingItem} onPress={handleRestart}>
          <Text style={[styles.settingLabel, { color: textColor }]}>{t("restart")}</Text>
          <Ionicons name="chevron-forward" size={20} color={chevronColor} />
        </TouchableOpacity>
        <View style={[styles.divider, { backgroundColor: dividerColor }]} />

        {/* Factory Reset */}
        <TouchableOpacity style={styles.settingItem} onPress={handleFactoryReset}>
          <Text style={[styles.settingLabel, { color: textColor }]}>{t("factoryReset")}</Text>
          <Ionicons name="chevron-forward" size={20} color={chevronColor} />
        </TouchableOpacity>
        <View style={[styles.divider, { backgroundColor: dividerColor }]} />
      </View>
